...
For the analysis only was used the variables with mean and std:
...
For the mean.txt file, the names of the activities are added to each variable along with the word mean.
